...
document.getElementsByClassName("vertical-menu__item").onclick = function() {
	document.getElementById("fullscreenMenu").style.display = "none";
}
