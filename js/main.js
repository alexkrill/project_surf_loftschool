...
$('.form__order').submit(e => {
    ...
    if (isValid) {
        ...
        request.always(() => {
            ...
            $('.fancybox__content').css('padding', '0');
            $('.carousel__button').css('display', 'none');
